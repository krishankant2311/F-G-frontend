...
//         `${process.env.REACT_APP_API_BASE_URL}/admin/get-material/${id}`,
//         { headers: headers }
//       );
...
//         navigate(`/panel/admin/all-materials/${pageNo}`);
//       } else {
//         toast.error(response.data.message);
//       }
//     } catch (error) {
...
//                 </div>
//                 {/* <div className="form-group">
//                   <label htmlFor="exampleInputEmail1">Job Status</label>
//                   <select
//                     name="status"
//                     onChange={handleInputChange}
//                     id=""
          ...
          <div className="card">
            ...
            <form onSubmit={handleSubmit}>
              <div className="card-body">
                ...
                <div className="form-group">
                  <label htmlFor="edit-material-cost">Cost</label>
                  <input
                    type="text"
                    className="form-control"
                    id="edit-material-cost"
                    placeholder="Optional — blank uses 50% of price"
                    value={formData.cost}
                    onChange={handleInputChange}
                    name="cost"
                    autoComplete="off"
                ...
                <div className="form-group">
                  <label htmlFor="edit-material-markup">Markup (%)</label>
                  <input
                    type="text"
                    className="form-control"
                    id="edit-material-markup"
                    placeholder="Optional — blank uses 100%"
                ...
                <div className="form-group">
                  <label htmlFor="edit-material-price">Material Price *</label>
                  <input
                    type="number"
                    className="form-control"
